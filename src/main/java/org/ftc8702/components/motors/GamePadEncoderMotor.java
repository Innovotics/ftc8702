 ...
 */
public class GamePadEncoderMotor extends OpModeComponent {
     ...
     */
//    public GamePadEncoderMotor(ActiveOpMode opMode, Gamepad gamepad, DcMotor motor, Control control) {
//
    ...
    public void update(int currentValue) {
        ...
        switch (control) {
            ...
            case RIGHT_STICK_Y:
                ...
                getOpMode().getTelemetryUtil().sendTelemetry();
