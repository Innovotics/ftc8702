...
import static org.ftc8702.opmodes.production.SkystoneAutoModeState.DETECT_SKYSTONE;
...
import static org.ftc8702.opmodes.production.SkystoneAutoModeState.PULL_FOUNDATION;
    ...
    protected void activeLoop() throws InterruptedException {
        ...
        switch (currentState) {
            ...
            case MOVE_TO_SECOND_SKYSTONE_LEFT:
                ...
                //readAngles();
                //currentYawAngle = angle.thirdAngle;
                robot.driveTrain.rotateRightWithGyro(.3f, -5);
                robot.driveTrain.strafeLeft(0.5f,0.3,600,100);
                ...
                robot.driveTrain.rotateRightWithGyro(0.5f,0);
                robot.jaja.JaJaUp();
                sleep(100);
                robot.driveTrain.rotateLeftWithGyro(0.5f,90);
                robot.driveTrain.stop();
            ...
            case MOVE_TO_SECOND_SKYSTONE_CENTER:
                ...
                robot.driveTrain.strafeLeft(0.4f,0.3,800,50);
                robot.driveTrain.goBackwardWithUltrasonic(.3f, .3, robot.distanceSensor, 10);
                robot.jaja.JaJaLeftDown();
                sleep(200);
                robot.driveTrain.goForwardWithoutPID(0.3f);
            ...
            case GRAB_SKY_STONE_RIGHT:
                ...
                robot.driveTrain.goBackwardWithBottomColorSensor(.7f, 0.3,robot.colorSensor);
            ...
            case PULL_FOUNDATION:
                ...
                sleep(400);
                robot.driveTrain.smoothTurnRightBack();
                sleep(900);
                ...
                robot.driveTrain.stop();
                sleep(300);
                robot.driveTrain.pivitStrongRight();
                sleep(1400);
