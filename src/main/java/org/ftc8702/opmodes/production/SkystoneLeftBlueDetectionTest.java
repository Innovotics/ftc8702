    ...
    protected void activeLoop() throws InterruptedException {
        ...
        switch (currentState) {
            case DETECT_SKYSTONE:
                ...
                robot.driveTrain.goBackward(0.3f,0.3,2000,100);
            ...
            case GRAB_SKY_STONE_CENTER:
                ...
                sleep(1000);
                robot.driveTrain.rotateLeftWithGyro(.3f, 90);
                robot.driveTrain.goBackward(.7f, 1, 2000, 100);
                robot.jaja.JaJaUp();
                sleep(100);
            ...
            case MOVE_TO_SECOND_SKYSTONE_CENTER:
                logStage();
                robot.driveTrain.goForward(.7f, 1, 3000, 100);
                ...
                sleep(300);
                robot.driveTrain.rotateRightWithGyro(.3f, 90);
                robot.driveTrain.goBackward(.7f, 0.5, 4000, 100);
                robot.jaja.JaJaUp();
                sleep(200);
                robot.driveTrain.stop();
                currentState = PARK;
            ...
            case MOVE_TO_SECOND_SKYSTONE_RIGHT:
                ...
                robot.driveTrain.strafeLeftWithoutPid(0.5f);
                sleep(1100);
                robot.driveTrain.goBackward(0.5f,0.2,600,70);
                sleep(500);
                robot.jaja.JaJaLeftDown();
                sleep(200);
