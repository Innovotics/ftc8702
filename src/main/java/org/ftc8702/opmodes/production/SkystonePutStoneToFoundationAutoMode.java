...
@Autonomous(name = "SkystonePutStoneToFoundationAutoMode", group = "Ops")
public class SkystonePutStoneToFoundationAutoMode extends SkystoneAbstractAutoMode {
        ...
        switch (getCurrentState()) {
            case LOWER_FOUNDATION_GRABBER:
                ...
                if(accomplishedTask == false) {
                    getRobot().foundationGrabberLeft.setPower(.5);
                    sleep(5000);
                    getRobot().foundationGrabberLeft.setPower(0);
